<x-layouts.anonyme :title="__('Worknest - Protection des données')">
  <main class="max-w-4xl mx-auto p-6 space-y-8">
    ...
    <section class="bg-white shadow rounded-lg p-6">
      ...
      <p class="mt-2 text-sm text-gray-600">Audits et réévaluations régulières seront mis en place à mesure de l’évolution de la plateforme.</p>
    </section>
    ...
    <section class="bg-white shadow rounded-lg p-6">
      ...
      <p class="text-sm text-gray-600">Les sous-traitants n’agissent que sur instruction de Worknest et dans le respect du RGPD.</p>
    </section>
    ...
    <section class="bg-white shadow rounded-lg p-6">
      ...
      <p>Toute demande peut être adressée à : <a href="mailto:support@worknest.fr" class="text-indigo-500 hover:underline">support@worknest.fr</a></p>
    </section>
    ...
    <section class="bg-white shadow rounded-lg p-6 text-gray-700">
      ...
      <p>La présente politique de confidentialité peut être amenée à évoluer. Toute modification sera publiée sur cette page avec mise à jour de la date d’entrée en vigueur.</p>
    </section>
